...
| 12 | Удалять игнорируемые поля   | ![](./img/logical.svg) Логический     |false                   |
| 13 | Имена выходов               | ![](./img/string.svg) Строковый       |null                    |
| 14 | Дополнительные выходы       | ![](./img/string.svg) Строковый       |null                    |
| 15 | Полный выходной датасет     | ![](./img/logical.svg) Логический     |true                    |
| 16 | Сохранять метки полей       | ![](./img/logical.svg) Логический     |true                    |
| 17 | Только коэффициенты         | ![](./img/logical.svg) Логический     |false                   |
