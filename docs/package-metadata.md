...
Компонент предназначен для парсинга пакета Loginom. Есть возможность ограничить количество модулей для парсинга, что отразится на агрегированной статистике. Таблицы по каждому модулю представлены в виде JSON-строки. Есть возможность настраивать структуру выходной JSON-строки.
...
| 6  | Включать входные порты узла   | ![](./img/logical.svg) Логический     |true                    |
| 6  | Включать выходные порты узла  | ![](./img/logical.svg) Логический     |true                    |
| 6  | Включать код узла             | ![](./img/logical.svg) Логический     |true                    |
