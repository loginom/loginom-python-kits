...
Загружает список переменных из текстового файла с настройками для компонентов-кодировщиков, который был ранее сохранен компонентом [Сохранить config](./save-config.md).
